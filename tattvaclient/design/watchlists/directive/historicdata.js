angular.module('tattva').directive('historicLinearChart', function(){
  return{
    restrict:'EA',
    ...
    link: function(scope, elem, attrs){
      ...
      var chartElemId = 'cntr-' + scope.watchname.replace(/\s+/g, '-').toLowerCase() + '-historic';
      ...
      //   chart.render();
      // };
      // saveToDB.getwatchlistdata().then(function(data) {
