    ...
    return {
      ...
      function drawmap() {
        ...
        if (watchdata.namespace !== "") {
         ...
         if(Object.keys(watchdata.publishers.dashboard).length!=0 || Object.keys(watchdata.publishers.database).length!=0 || Object.keys(watchdata.publishers.outstream).length!=0)
         {
     parent.children=[];
          // for(var i=0;i<Object.keys(watchdata.publishers).length;i++)
          // {
          //    if((Object.keys(watchdata.publishers)[i]).length!=0)
          //    { console.log((Object.keys(watchdata.publishers)[i]).length!=0);
          //         parent.children.push({
          //        "name":Object.keys(watchdata.publishers)[i] ,
          ...
          // }
            ...
            var arr=['database','outstream','dashboard',];
            if(Object.keys(watchdata.publishers.dashboard).length!=0 && Object.keys(watchdata.publishers.database).length!=0 && Object.keys(watchdata.publishers.outstream).length!=0)
            {
            ...
            if(Object.keys(watchdata.publishers.dashboard).length!=0  &&  Object.keys(watchdata.publishers.database).length!=0)
            {
                console.log("21");
              parent.children[0] = {
                "name": "dashboard",
            ...
            if(Object.keys(watchdata.publishers.dashboard).length!=0  && Object.keys(watchdata.publishers.outstream).length!=0)
            {
              parent.children[0] = {
                "name": "dashboard",
                "color": colorcode[3].color,
            ...
            if(Object.keys(watchdata.publishers.dashboard).length!=0)
            {
              parent.children[0] = {
                "name": "dashboard",
                "color": colorcode[3].color,
