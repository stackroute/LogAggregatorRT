angular.module('tattva')
    .controller("InstanceCtrl", ["$rootScope", "$scope", "$state", "$http",
        "$stateParams", "$mdDialog", "$mdMedia", "namespaceFactory",
        function($rootScope, $scope, $state, $http, $stateParams, $mdDialog, $mdMedia,
            namespaceFactory) {
            ...
            namespaceFactory.getNameSpace().then(function(response) {
                ...
                $state.go("design.instance.viewInstance", {
            ...
            $scope.addInstance = function($event) {
                ...
                function DialogController($scope, $state, $mdDialog, $http) {
                    namespaceFactory.getNameSpace().then(function(response) {
                        $scope.namespaceSelect = response;
                    });
                    ...
                    $scope.instanceSubmit = function() {
                        ...
                        $http({
                            ...
                            arr.push("on");
                            arr.push(moment().startOf($scope.updatedInstance.createdOn)
