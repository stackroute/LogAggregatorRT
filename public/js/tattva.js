...
tattva.config(['$stateProvider','$urlRouterProvider', function($stateProvider){
  ...
  .state('mainstream.streams.viewInstance',
  {
  	url:'/:name',
    views: {
      "header" : {
...
var tattva = angular.module('tattva', ['ngMaterial', 'ngMdIcons','ui.router','ui.ace','ngScrollbars','ngLetterAvatar']);
tattva.controller('AppCtrl', ['$scope', '$rootScope',
  function($scope) {
    $scope.operator=['>','<']
    $scope.showmesecound=true;
...
>>>>>>> e35064730a9416992e2dca135fe96397ad3a8af6
